...
void BSDFDataSample::set_intensity_index(size_t intensity_index)
{
    ...
    if (!m_cache_mask[m_intensity_index])
    {
        ...
        compute_normalized_heights(m_raw_measurement, m_points_stats, m_h[m_intensity_index], m_lh[m_intensity_index], m_intensity_index);
        ...
        compute_normals(m_f, m_v2d, m_h[m_intensity_index], m_lh[m_intensity_index], m_n[m_intensity_index], m_ln[m_intensity_index]);
    }
    update_shaders_data();
