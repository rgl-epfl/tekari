...
extern void select_all_points(VectorXu8 &selected_points);
extern void deselect_all_points(VectorXu8 &selected_points);

extern void move_selection_along_path(bool up, VectorXu8 &selected_points);
