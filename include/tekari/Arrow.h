...
public:
	...
	void load_shaders()
	{
	    ...
	    m_cone_shader.init_from_files("cone", shader_path + "arrow.vert", shader_path + "arrow.frag");
	    m_cylinder_shader.init_from_files("cylinder", shader_path + "arrow.vert", shader_path + "arrow.frag");
